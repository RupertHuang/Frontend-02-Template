...
export class Carousel {
    ...
    render(){
        ...
        let children = this.data.map((url, currentPosition) => {
            ...
            let onPanend = event => {
                ...
                let lastAnimation = new Animation(lastElement.style, "transform", 
                    - 500 - 500 * lastPosition + offset + dx, -500 * lastPosition + direction *
                    500, 500, 0, ease, v => `translateX(${v}px)`);
                let currentAnimation = new Animation(currentElement.style, "transform", 
                    - 500 - 500 * currentPosition + offset + dx, -500 * currentPosition + direction *
                    500, 500, 0, ease, v => `translateX(${v}px)`);
                let nextAnimation = new Animation(nextElement.style, "transform", 
                    - 500 - 500 * nextPosition + offset + dx, -500 * nextPosition + direction *
                    500, 500, 0, ease, v => `translateX(${v}px)`);
                ...
                // current.style.tranform = `translateX(${ offset * 500 - 500 * position}px)`
        ...
        let nextPic = () => {
            ...
            - 100 * nextPosition, - 100 - 100 * nextPosition, 500, 0, ease, v => `translateX(${5 * v}px)` );
